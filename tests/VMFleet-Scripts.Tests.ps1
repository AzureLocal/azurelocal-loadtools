...
BeforeAll {
    ...
    $script:VMFleetScriptsPath = Join-Path $script:ProjectRoot 'src\solutions\vmfleet\scripts'
    $script:VMFleetRootPath = Join-Path $script:ProjectRoot 'src\solutions\vmfleet'
    $script:MonitoringPath = Join-Path $script:VMFleetRootPath 'monitoring'
    $script:InfraPath = Join-Path $script:ProjectRoot 'src\infrastructure'
}

Describe 'VMFleet Script Standards Compliance' {
    $testCases = @(
        @{ Name = 'Invoke-VMFleetPipeline.ps1'; Path = 'src\solutions\vmfleet\Invoke-VMFleetPipeline.ps1' }
        @{ Name = 'Install-VMFleet.ps1'; Path = 'src\solutions\vmfleet\scripts\Install-VMFleet.ps1' }
        @{ Name = 'Deploy-VMFleet.ps1'; Path = 'src\solutions\vmfleet\scripts\Deploy-VMFleet.ps1' }
        @{ Name = 'Start-VMFleetTest.ps1'; Path = 'src\solutions\vmfleet\scripts\Start-VMFleetTest.ps1' }
        @{ Name = 'Stop-VMFleetTest.ps1'; Path = 'src\solutions\vmfleet\scripts\Stop-VMFleetTest.ps1' }
        @{ Name = 'Watch-VMFleetMonitor.ps1'; Path = 'src\solutions\vmfleet\scripts\Watch-VMFleetMonitor.ps1' }
        @{ Name = 'Collect-VMFleetResults.ps1'; Path = 'src\solutions\vmfleet\scripts\Collect-VMFleetResults.ps1' }
        @{ Name = 'Remove-VMFleet.ps1'; Path = 'src\solutions\vmfleet\scripts\Remove-VMFleet.ps1' }
        @{ Name = 'Prepare-VMFleetBaseImage.ps1'; Path = 'src\infrastructure\Prepare-VMFleetBaseImage.ps1' }
    )
...
Describe 'VMFleet Monitoring Scripts' {
    $monitoringCases = @(
        @{ Name = 'Collect-StorageMetrics.ps1'; Path = 'src\solutions\vmfleet\monitoring\Collect-StorageMetrics.ps1' }
        @{ Name = 'Collect-ComputeMetrics.ps1'; Path = 'src\solutions\vmfleet\monitoring\Collect-ComputeMetrics.ps1' }
        @{ Name = 'Collect-NetworkMetrics.ps1'; Path = 'src\solutions\vmfleet\monitoring\Collect-NetworkMetrics.ps1' }
        @{ Name = 'Push-MetricsToAzureMonitor.ps1'; Path = 'src\solutions\vmfleet\monitoring\Push-MetricsToAzureMonitor.ps1' }
        @{ Name = 'Export-MetricsDashboard.ps1'; Path = 'src\solutions\vmfleet\monitoring\Export-MetricsDashboard.ps1' }
    )
