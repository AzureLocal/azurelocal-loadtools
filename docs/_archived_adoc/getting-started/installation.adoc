...
This guide walks through the installation and initial setup of the {project-name}.
...
Ansible is installed as part of the CI/CD pipeline. See the link:../operations/ci-cd.adoc[CI/CD Pipelines] guide.
...
* link:configuration.adoc[Configuration] — Understand the configuration system
* link:../tools/vmfleet/overview.adoc[VMFleet Guide] — Start with VMFleet storage testing
