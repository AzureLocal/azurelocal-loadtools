...
Before deploying the {project-name}, ensure the following common prerequisites are met. Individual tools may have additional requirements — see each tool's prerequisites page.
...
* link:../tools/vmfleet/prerequisites.adoc[VMFleet Prerequisites] — Base VHD, Collect volume, VMFleet module
* link:../tools/fio/overview.adoc[fio Prerequisites] — Linux VMs, fio package
* link:../tools/iperf/overview.adoc[iPerf3 Prerequisites] — iPerf3 binaries, RDMA configuration
* link:../tools/hammerdb/overview.adoc[HammerDB Prerequisites] — SQL Server, HammerDB installation
* link:../tools/stress-ng/overview.adoc[stress-ng Prerequisites] — Linux VMs, stress-ng package

== Next Steps

* link:installation.adoc[Installation] — Install the framework and dependencies
